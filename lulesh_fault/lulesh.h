...
class Domain {
   ...
   MPI_Request *recvRequest; // 6 faces + 12 edges + 8 corners 
   MPI_Request *sendRequest; // 6 faces + 12 edges + 8 corners
...
// lulesh-comm
int CommRecv(Domain& domain, Int_t msgType, Index_t xferFields,
...
int CommSBN(Domain& domain, Int_t xferFields, Domain_member *fieldData);
